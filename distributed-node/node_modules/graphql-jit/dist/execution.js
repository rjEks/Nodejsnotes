...
function compileQuery(schema, document, operationName, partialOptions) {
    ...
    try {
        const options = Object.assign({ disablingCapturingStackErrors: false, customJSONSerializer: false, disableLeafSerialization: false, customSerializers: {} }, partialOptions);
